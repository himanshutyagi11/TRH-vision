...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates', BASE_DIR / 'vision' / 'templates'],
        'APP_DIRS': False,
        'OPTIONS': {
            'context_processors': [
...
# Email Configuration
# IMPORTANT: Before using in production, create an email account in Hostinger
# (e.g., noreply@trhvision.in or support@trhvision.in) and update the credentials below

# For Development: Print emails to console (uncomment this line for testing)
